...
export async function generateAutoResponse(
  ...
  try {
    ...
    const isAck = /^(ok|okk|okey|okay|okayy|okkay|k|kk|yes|yep|yup|ya|haa|haan|han|ji|thik|theek|acha|accha|hm|hmm|hmmm|no|nah|nahi|thank|thanks|shukriya)$/i.test(normalizedText);
